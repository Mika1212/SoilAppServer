...
public class HSLConvertor
{
     ...
     */
    public HSLConvertor(float h, float s, float l, float alpha)
    {
        hsl = new float[] {h, s, l};
        this.alpha = alpha;
        rgb = toRGB(hsl, alpha);
     ...
     *  @param alpha the alpha value between 0 - 1
     */
    public HSLConvertor(float[] hsl, float alpha)
    {
        this.hsl = hsl;
        this.alpha = alpha;
        rgb = toRGB(hsl, alpha);
